...
const WorkerProfile = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Banner */}
      <div style={{ background: "linear-gradient(135deg, #1A56DB 0%, #1e40af 100%)" }} className="rounded-2xl h-24 mb-0 relative" />
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-end gap-4 mb-4">
              <img src={avatar} alt={workerUser.name} className="w-20 h-20 rounded-full border-4 border-white shadow-lg -mt-10 object-cover flex-shrink-0" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-gray-50 rounded-xl p-4 mb-5">
              ...
              <div className="text-center">
                <p className="text-sm font-bold text-[#1A56DB] leading-tight">from {formatUZS(worker.jobRate)}</p>
              ...
              <div className="flex flex-wrap gap-2">
                {worker.services?.map((s) => (
                  <div key={s} className="flex items-center gap-3 bg-blue-50 rounded-lg px-4 py-2.5">
                    ...
                    <span className="text-sm font-bold text-[#1A56DB]">from {formatUZS(worker.jobRate)}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-blue-50 rounded-lg p-3">
                  ...
                  <p className="font-bold text-[#1A56DB] text-lg">
                    from {formatUZS(worker.jobRate)}
                    <span className="text-sm font-normal text-gray-500"> / job</span>
                  </p>
                  <p className="text-xs text-gray-400 mt-0.5">Final price agreed on-site</p>
                </div>
